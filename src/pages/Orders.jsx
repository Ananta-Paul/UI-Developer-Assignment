          ...
          <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
            <div className="flex items-center gap-4">
              <Button size="sm" className="bg-primary hover:bg-primary/90">
                <Plus className=" text-xs h-4 w-4 mr-2" />
                Add
              </Button>
              <Button variant="outline" size="sm">
                <Filter className=" text-xs h-4 w-4 mr-2" />
                Filter
              </Button>
              <Button variant="outline" size="sm">
                <ArrowUpDown className="text-xs h-4 w-4 mr-2" />
                Sort
              </Button>
            </div>
            <div className="flex-1 max-w-md">
              <div className="relative">
                <Search className=" text-xs absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-muted-foreground" />
                <Input
                    ...
                    <td className="py-3 px-2">
                      <Checkbox
                        ...
                        onCheckedChange={(checked) =>
                          handleSelectOrder(index, checked)
                        }
                      />
                    </td>
